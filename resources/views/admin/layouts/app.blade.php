    ...
    <div id="app">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ ('admin.program.index')}}">Программы</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin.program4.index')}}">Программы4</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('admin.period.index')}}">Сроки поступления</a>
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                Реструктуризатор <span class="caret"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('admin.restucturing.index')}}">Главная</a>
                            </div>
                        </li>
                    </ul>
        ...
        <div id="wrapper">
            <header id="header">
                <nav>
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link" href="{{ route('admin.program3.index')}}">Программы3</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('admin.faculty.index')}}">Факультеты</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('admin.direction.index')}}">Направления</a></li>
                        <li class="nav-item"><a class="nav-link" href="">КЦП</a></li>
                        <li class="nav-item"><a class="nav-link" href="">Цены</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('admin.period.index')}}">Сроки поступления</a></li>
                        <li class="nav-item"><a class="nav-link" href="">Сроки обучения</a></li>
                    </ul>
                </nav>
            </header>
            <main class="py-4">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.add_select').on('click', function(){
                var select = $(this).parent().find('select').last().clone();
                select = $(select).val('');
