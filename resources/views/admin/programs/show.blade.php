    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex align-items-center my-4">
                ...
                <a href="{{ route('admin.program.edit', $program->id) }}" class="btn btn-primary ml-auto"><i class="fas fa-pen"></i> Редактировать</a>
            </div>
            ...
            <table class="border table table-borderless table-light">
                <tbody class="programs_container">
                    ...
                    <tr>
                        ...
                        <td>@include('partials.program_forms_list', ['forms' => $forms, 'program_forms' => $program->form_ids, 'tag' => 'span'])</td>
                    </tr>
                    <tr><td>Статус</td><td>{{$program->status}}</td></tr>
                    <tr><td>Срок обучения</td><td>{{$program->duration_study}}</td></tr>
                    <tr><td>Возможный срок обучения</td><td>{{$program->possible_duration_study}}</td></tr>
                    ...
                    <tr><td>Цена проекта</td><td>{{$program->price}}</td></tr>
                    <tr><td>Предметы</td><td>{{$program->courses}}</td></tr>
